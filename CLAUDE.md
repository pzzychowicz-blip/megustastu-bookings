...
│   └── useLayout.js                 editable table layout (capacity/zone) + combos → constants.js live bindings via setLayout; Firebase settings/layout (v15.0.0; 4th settings node)
├── components/
...
│   ├── LayoutSettings.jsx           Layout-tab body (v15.0.0) — per-table capacity/zone + kitchen limit + collapsible Combos editor (join-group cap overrides + cross-group read-back)

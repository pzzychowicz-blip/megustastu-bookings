...
│   ├── ListView.jsx                 sorted card list; completed/cancelled fold into a controlled Collapsible — open state in BookingApp for keyboard-nav sync (v15.1.0)
...
│   ├── Settings.jsx                 settings modal shell + tabs (General/Layout/Reminders/Shortcuts); General = per-weekday hours · optimizer cutoff(0–24)/auto-switch · shifts, sections collapsible (v15.0.0)

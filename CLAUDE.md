...
│   └── atoms.jsx                    Overlay (+ pinned-footer slot), Fld, Section, Collapsible (v15.0.0; optional controlled mode `open`/`onToggle` v15.1.0), TBadge, AvailBanner, Toggle, mkInp, mkBtn
└── lib/

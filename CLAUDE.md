...
- **Animate only the range that is VISIBLE (v17.9.1).** `AutoHeight` inside a
  ...
  frames, which is what "it jumps" meant. A `watch` swap now runs over the clamped

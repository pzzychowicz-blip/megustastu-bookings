...
export function BookingFormModal({
  ...
  const regularChip=custMatch&&custMatch.regularCount>=1?<button
    ...
    style={Object.assign({},chipBase,{border:"2px solid var(--suggest-border)",color:"var(--success-text)"})}>{regularChipLabel(custMatch.regularCount,regularMin)+(histWhich==="regular"?" ▾":" ▸")}</button>:null;

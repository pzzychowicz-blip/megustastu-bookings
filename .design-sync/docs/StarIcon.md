---
category: Icons
keywords: [star, preferred, favourite]
---
Preferred tables. The one FILLED icon in the set, so it survives as a flag on a saturated booking block. Takes only `size`.
